  ...
  return (
    <section className={Styles.category_row}>
      <div className={Styles.category_container}>
        <Link href="/headphones" className={Styles.category_link}>
        ...
        <Link href="/speakers" className={Styles.category_link}>
          <div className={Styles.category_column}>
        ...
        <Link href="/earphones" className={Styles.category_link}>
          <div className={Styles.category_column}>
